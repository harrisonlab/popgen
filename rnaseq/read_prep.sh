...
fq_p="${fq_fd%/F}/R"
qsub $scripts/sub_star_sensitive.sh fvesca_v1.1_all.fa $fq_f $fq_p/$fq_r "vesca_${fq_fb%_R1_trim.fq.gz}" Fragaria_vesca_v1.1.a2.gff3
done
##To P.cactorum
...
fq_r="${fq_fb%_R1_trim.fq.gz}_R2_trim.fq.gz"
fq_p="${fq_fd%/F}/R"
qsub $scripts/sub_star_sensitive.sh contigs_min_500bp_renamed.fasta $fq_f $fq_p/$fq_r "pcac_${fq_fb%_R1_trim.fq.gz}" final_genes_appended.gff3
done
