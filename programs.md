...
[RGAugury] (https://bitbucket.org/yaanlpc/rgaugury/): A pipeline for genome-wide prediction of resistance gene analogs (RGAs) in plants. **Multiple dependencies**
...
[transAlign ver. 1.2] (https://www.uni-oldenburg.de/ibu/systematik-evolutionsbiologie/programme/) An open-source Perl script that aligns protein-coding DNA sequences via their amino-acid translations `/home/sobczm/bin/transalign`
