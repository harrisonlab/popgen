...
a <- data.frame(Cultivar = "Emily", value = stats1$coverage, length=stats1$aln_length, qlen=stats1$qlen, hlen=stats1$hlen)
b <- data.frame(Cultivar = "Fenella", value = stats2$coverage, length=stats2$aln_length, qlen=stats2$qlen, hlen=stats2$hlen)
