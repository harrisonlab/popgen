...
output=$input/gatk/renseq_lorma_emily_ref2.vcf

filename=$(basename "$reference")

gatk=/home/sobczm/bin/GenomeAnalysisTK-3.6

java -Xmx20g -jar $gatk/GenomeAnalysisTK.jar -R $reference -T HaplotypeCaller -ploidy 2 -nct 4 -maxAltAlleles 8 --allow_potentially_misencoded_quality_scores --defaultBaseQualities 30 -I $input/bwa_lorma_emily_all_own/reads.sorted_unique_sorted_rg.bam -I $input/bwa_lorma_fenella_all_cross/reads.sorted_unique_sorted_rg.bam -o $output
