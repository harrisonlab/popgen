...
a <- data.frame(Cultivar = "Emily", length=stats1$utr_length, qlen=stats1$qlen, hlen=stats1$hlen)
b <- data.frame(Cultivar = "Fenella", length=stats2$utr_length, qlen=stats2$qlen, hlen=stats2$hlen)
