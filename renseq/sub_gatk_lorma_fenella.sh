...
output=$input/gatk/renseq_lorma_fenella_ref.vcf

filename=$(basename "$reference")

gatk=/home/sobczm/bin/GenomeAnalysisTK-3.6

java -jar $gatk/GenomeAnalysisTK.jar -R $reference -T HaplotypeCaller -ploidy 8 -nct 6 --allow_potentially_misencoded_quality_scores --defaultBaseQualities 30 -I $input/bwa_lorma_emily_all_cross/reads.sorted_unique_sorted_rg.bam -I $input/bwa_lorma_fenella_all_own/reads.sorted_unique_sorted_rg.bam -o $output
