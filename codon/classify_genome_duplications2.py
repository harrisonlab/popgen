...
"contig_5_pilon", "contig_6_pilon", "contig_7_pilon", "contig_8_pilon", "contig_9_pilon", "contig_11_pilon", "contig_12_pilon", "contig_13_pilon",
...
for line in sf_h:
    ...
    if match[0] in contigs:
        for a in all_hits:
            ...
            if ((contigs[match[0]] in core) and (contigs[match_a[0]] in core)):
                c_c += 1
