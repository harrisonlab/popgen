...
#Further dissection of Fus2 codon bias analysis results into lineage-specific (all LS, SS and PS) and core region.

#Prepare independent annotation tables for lineage-specific and core region genes
cd $input/inhouse/no_transposons/Fus2_final_genes_combined.cdna_pass_one_notrans
...
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/CAZY/all/Fus2_canu_new_CAZY_gene_table_ss.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/CAZY/all/Fus2_canu_new_CAZY_gene_table_ps.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
...
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/CAZY/secreted/Fus2_canu_new_CAZY_secreted_gene_table_ss.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/CAZY/secreted/Fus2_canu_new_CAZY_secreted_gene_table_ps.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
...
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/effectorP/secreted/F.oxysporum_fsp_cepae_Fus2_canu_new_EffectorP_secreted_gene_table_ss.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/effectorP/secreted/F.oxysporum_fsp_cepae_Fus2_canu_new_EffectorP_secreted_gene_table_ps.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
...
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/mimp/secreted/Fus2_canu_new_genes_in_2kb_mimp_secreted_gene_table_ss.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/mimp/secreted/Fus2_canu_new_genes_in_2kb_mimp_secreted_gene_table_ps.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
...
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/mimp/all/Fus2_canu_new_genes_in_2kb_mimp_gene_table_ss.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py $effectors/mimp/all/Fus2_canu_new_genes_in_2kb_mimp_gene_table_ps.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
...
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py Fus2_final_genes_appended_gene_table_ss.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
python $scripts/match_ids.py Fus2_final_genes_appended_gene_table_ps.txt \
Fus2_final_genes_combined.cdna_pass_one_notrans.out
...
#Execute separately for lineage-specific (_ls, _ss, _ps) and core (_c) regions as well as all regions.
cp $scripts/codonw_analysis.R ./core
mv codonw_analysis.R codonw_analysis_c.R
Rscript --vanilla codonw_analysis_c.R

cp $scripts/codonw_analysis.R ./ls
mv codonw_analysis.R codonw_analysis_ls.R
Rscript --vanilla codonw_analysis_ls.R

cp $scripts/codonw_analysis.R ./ss
mv codonw_analysis.R codonw_analysis_ss.R
Rscript --vanilla codonw_analysis_ss.R

cp $scripts/codonw_analysis.R ./ps
mv codonw_analysis.R codonw_analysis_ps.R
Rscript --vanilla codonw_analysis_ps.R

cp $scripts/codonw_analysis.R ./all
